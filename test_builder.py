...
class DoricusBuilderTestCases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = 'sqlite:///test_db_builder.db'
...
def suite():
    ...
    suite.addTest(DoricusBuilderTestCases('test_1_create_account'))
    suite.addTest(DoricusBuilderTestCases('test_2_create_project'))
    suite.addTest(DoricusBuilderTestCases('test_3_update_project'))
    suite.addTest(DoricusBuilderTestCases('test_4_create_topic'))
